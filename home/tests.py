...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        ...
        :return:
        """
        t_time = timezone.now() + datetime.timedelta(days=30)
        future_question = Question(pub_date=t_time)
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The detail view of question with a pub_date in the future return a 404 not found.
        :return:
        """

        future_question = create_question(question_text="Future question.", days=5)
        url = reverse('home:detail', args=(future_question))
